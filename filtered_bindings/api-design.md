...
- [dependency-inversion](dependency-inversion.md): Well-designed APIs with clear
...
- [hex-domain-purity](hex-domain-purity.md): Explicit API design supports hexagonal
