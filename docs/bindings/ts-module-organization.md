...
- [dependency-inversion](dependency-inversion.md): Proper module organization works
...
- [hex-domain-purity](hex-domain-purity.md): Feature-based module organization naturally
...
- [immutable-by-default](immutable-by-default.md): Module boundaries are more effective
